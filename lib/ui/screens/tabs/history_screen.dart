...
class _HistoryScreenState extends State<HistoryScreen> {
  ...
  void loadLatestSymptoms() {
    setState(() {
      latestSymptoms = SymptomRepository.getAll();
    });
  }
                        ...
                        children: [
                          ...
                          Dismissible(
                            ...
                            onDismissed: (direction) {
                              final removedLog = latestSymptoms[index];
                              final removedIndex = index;
                              setState(() {
                                latestSymptoms.removeAt(index);
                              });
                              ...
                              Future.delayed(
                                ...
                                () async {
                                  if (!latestSymptoms.contains(removedLog)) {
                                    await SymptomRepository.deleteLog(
                                      removedLog.id,
                                    );
                                  }
                                },
